...
///////////////////////////////////////////////////////////////////
  ...
  h_wj = (TH1F *)f01->Get("NDiJetCombinations/HT");
    h_wj->SetLineColor(1);
    h_wj->SetFillColor(kAzure+6);
    h_wj->Scale(1);
  h_dy = (TH1F *)f02->Get("NDiJetCombinations/HT");
    h_dy->SetLineColor(1);
    h_dy->SetFillColor(kOrange-4);
    //h_dy->Scale(0.98);
  h_tt = (TH1F *)f03->Get("NDiJetCombinations/HT");
    h_tt->SetLineColor(1);
    h_tt->SetFillColor(kBlue-8);
  h_st = (TH1F *)f04->Get("NDiJetCombinations/HT");
    h_st->SetLineColor(1);
    h_st->SetFillColor(8);
  h_vv = (TH1F *)f06->Get("NDiJetCombinations/HT");
    h_vv->SetLineColor(1);
    h_vv->SetFillColor(46);
  h_ratio = (TH1F *)f901->Get("NDiJetCombinations/HT");
  h_data = (TH1F *)f900->Get("NDiJetCombinations/HT");
    //h_data->Scale(8.9);
  ...
  h_back = (TH1F *)f00->Get("NDiJetCombinations/HT");
  h_back->Sumw2();
  h_back->Add(h_dy);
  h_back->Add(h_tt);
  h_back->Add(h_st);
...
cout<<"--------------------------------------------"<<endl;
 ...
 double xbins_ht[11] = {200,300,400,500,600,700,800,900,1000,1200,2500};
 h_wj->Rebin(10,"hb_wj",xbins_ht);
    h_dy->Rebin(10,"hb_dy",xbins_ht);
    h_tt->Rebin(10,"hb_tt",xbins_ht);
    h_st->Rebin(10,"hb_st",xbins_ht);
    h_vv->Rebin(10,"hb_vv",xbins_ht);
    h_data->Rebin(10,"hb_data",xbins_ht);
    h_back->Rebin(10,"hb_back",xbins_ht);
    h_ratio->Rebin(10,"hb_ratio",xbins_ht);
 // h_wj->Rebin(1);
 // h_dy->Rebin(1);
 // h_tt->Rebin(1);
 // h_st->Rebin(1);
...
TPad *pad2 = new TPad("pad2", "pad2", 0, 0, 1, 0.25);
  ...
  pad2->cd();       // pad2 becomes the current pad
	...
	gPad->SetLeftMargin(0.15);
    	gPad->SetRightMargin(0.05);
	TLine *line = new TLine(200,1,2500,1);
	line->SetLineColor(2);
...
c0->SaveAs("diTau_dyCR2016_ht_101420.pdf");
}
